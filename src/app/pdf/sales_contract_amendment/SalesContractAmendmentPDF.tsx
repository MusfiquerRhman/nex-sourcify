...
const SalesContractAmendmentPDF = ({ data }: { data: GetPDFDataOutput }) => {
    ...
    return (
        <Document
            ...
            author="Nex Sourcify"
            subject="Sales Contract Amendment PDF"
            keywords="Sales, Contract, Amendment, PDF, Nex Sourcify, ERP"
...
export default SalesContractAmendmentPDF;