...
import type { exportReportRouter } from '~/server/api/routers/reports/exportReport'
import { useDecodedUser } from "~/hooks";

type ExportReportOutput = inferRouterOutputs<typeof exportReportRouter>;

type GetPDFDataOutput = ExportReportOutput['getExportReport'];
...
const ExportReportPDF = ({ data, fromDate, toDate, selectedFields }: ExportReportPDFProps) => {
    ...
    return (
        ...
        >
			<Page orientation="landscape" size="A4" style={styles.body} wrap>
				...
				<Table columns={tableColumns} data={data.exportReportData}/>
