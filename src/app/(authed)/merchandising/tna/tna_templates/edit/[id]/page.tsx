...
const EditTnaTemplatePage = ({ params }: ParamsProp) => {
    ...
    const { data: tnaTemplateData, isLoading } = api.tnaTemplates.getTnaTemplateById.useQuery({ id: id });
    ...
    const updateTNATemplate = api.tnaTemplates.updateTnaTemplate.useMutation({
        onSuccess: async () => {
            setError(null);
            toast.success("TNA Template updated successfully!");
            await utils.tnaTemplates.getTnaTemplates.invalidate();
            await utils.tnaTemplates.getTnaTemplateById.invalidate({ id: id });
        },
    });
        ...
        try {
            setIsLoadingSubmit(true);
             ...
             const payload = {
                ...
                team_id: Number(tnaTemplateData.team_id),
