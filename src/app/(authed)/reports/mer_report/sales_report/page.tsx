...
import { useSalesReportForm } from "./config/useSalesReportForm";

const SalesReportPage = () => {
	// Form setup
	const { methods, handleSubmit, formFields, validationError, control } = useSalesReportForm();

	// TRPC utils    
	const pdfURL = '/pdf/sales_report/';

	const onSubmitAll = handleSubmit(async (salesReportData) => {
		const params = new URLSearchParams();

		Object.entries({
			base: salesReportData.base,
